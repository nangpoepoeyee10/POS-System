...
Route::middleware('auth')->group(function () {
    Route::middleware('admin_auth')->group(function () {
        ...
        Route::middleware('role:super admin')->group(function () {
            ...
            Route::post('permissions/delete', [App\Http\Controllers\PermissionController::class, 'destoryPermission'])->name('destoryPermission');
            Route::post('permission/update', [PermissionController::class, 'updatePermission'])->name('updatePermission');

            //Roles
            Route::resource('roles', \App\Http\Controllers\RoleController::class);
            Route::post('roles/delete', [App\Http\Controllers\RoleController::class, 'destoryRole'])->name('destroyRole');
